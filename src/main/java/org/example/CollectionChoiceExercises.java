...
public class CollectionChoiceExercises {
    public void MakeColorCollection() {
        ...
        String[] colors = {"Red", "Green", "Blue"}; //Array
    }
    ...
    public void MakeLoggedInUsersCollection() {
        ...
        HashSet<String> usernames = new HashSet<String>(); //HashSet
    ...
    public void MakeEmployeeAccessCodesCollection() {
        ...
        HashMap <String, String> accessNameList = new HashMap <String, String> (); //HashMap
    }
}
